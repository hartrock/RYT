...
function window_onload () {
  ...
  textFieldWithText =
    r.eg.createTextFieldAtXY(0, 0, aText,
			     {
  ...
  var textFieldWithoutText =
    r.eg.createTextFieldAtXY(0, 0,
			     null, // no text
			     null, null, // no text, no bg attrs
			     eg.Point.xy(100, 20));
  var button = r.eg.createTextButtonAtXY(0, 0, "text button");
  
  // on/off button
  var offButton = r.eg.createTextButtonAtXY(0, 0, "off button");
  var onButton = r.eg.createTextButtonAtXY(0, 0, "this is the on button");
  var onOffButton = r.eg.createOnOffButtonFrom(offButton, onButton,
					       true); // alignment
  var
  radioButton_1_on = r.eg.createTextButton("#1 on", {"fill":"red", "stroke":"red"}),
  radioButton_1_off = r.eg.createTextButton("#1 off"),
  radioButton_1 = r.eg.createOnOffButtonFrom(radioButton_1_off, radioButton_1_on, true),
  radioButton_2_on = r.eg.createTextButton("#2 on", {"fill":"red", "stroke":"red"}),
  radioButton_2_off = r.eg.createTextButton("#2 off"),
  radioButton_2 = r.eg.createOnOffButtonFrom(radioButton_2_off, radioButton_2_on, true),
  radioButton_3_on = r.eg.createTextButton("#3 on", {"fill":"red", "stroke":"red"}),
  radioButton_3_off = r.eg.createTextButton("#3 off"),
  radioButton_3 = r.eg.createOnOffButtonFrom(radioButton_3_off, radioButton_3_on, true);
  ...
  radioButtonsWidget = r.eg.createRadioButtons(radioButtons);

  radioButtonsWidget.click(eg.bindAsEventListener((function() { eg.log(this.state); }),
                                                  radioButtonsWidget));
  var
  aText = "this is a not printed textfield\nwith a not TTTTT second line...",
  textField = r.eg.createTextField(aText,
                                   {
  ...
  var onOffButton
    = r.eg.createOnOffTextButton("off", "   x", null, {"fill":"red", "stroke":"red"});

  var task = { type: 'task', id: '4711', name: "this is a task: double click for editing it" };
  var taskButton
    = r.eg.createTextFieldAtXY(0,0, task.name);
  ...
  var mw = r.eg.createMilestonesWidget(pos, 400, eg.Point.xy(20,20));
